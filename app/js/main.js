...
window.onload = function() {
    ...
    function init() {
        ...
        images = loadImages(["/interactive/2018/10/bubble/images/bubble-sprites.png"]);
    ...
    function main(tframe) {
        ...
        if (!initialized) {
            ...
            var loadtext = "Loading " + loadcount + "/" + loadtotal + " images";
            context.fillStyle = "#000000";
            context.font = "16px Akkurat";
            context.fillText(loadtext, 25, 0.5 + canvas.height - 30);
    ...
    function render() {
        ...
        //uncomment the lines below and comment out context.fillRect below in order to use a background image instead of color
        // var background = new Image();
        // background.src = "/interactive/2018/10/bubble/images/x.png";
        // context.drawImage(background,level.x - 4, level.y - 4, level.width + 8, level.height + 4 - yoffset);

        // Draw level background
        context.fillStyle = "#000000";
        // comment out the below if you want to use a background image
    ...
    function drawFrame() {
        ...
        // Draw header
        // context.fillStyle = "#000000";
        // context.fillRect(0, 0, canvas.width, 202);

        var banner = new Image();
        banner.src = "/interactive/2018/10/bubble/images/banner.png";
        context.drawImage(banner,0, 0, canvas.width, 202);

        // Draw title
        context.fillStyle = "#000000";
        context.font = "40px TrimPoster-Slender";
        context.fillText("Pumpkin Shooter", 10,45);

        // Display fps
        context.fillStyle = "#ffffff";
        context.font = "12px Akkurat";
